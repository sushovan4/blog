...
function runNext(player, current){
  ...
  audio.play();
    ...
    <textArea id ="text" type="text" name="myText" onkeypress=" return sendDoc(event)"
	      rows="2"  style="position:fixed;
					 bottom: 0;
					 left: 0;"></textArea> 
    <button type="button" class="btn btn-success" onclick="sendDoc('send')" style="position: fixed; bottom: 0; right: 0;">Send</button>

    
    <div id="chat" class="text-center">
      <h5>Nita, welcome to Chat</h5>  
  ...
  <ul id="playlist" style="visibility:hidden;">
	...
	xhttp = new ActiveXObject("Microsoft.XMLHTTP");
      ...
      xhttp.open("GET", "messageFetcherSush.php", true);
      xhttp.send();
      }
      ...
      xhttp.open("GET", "messageAppenderNita.php?q=" + "Nita: " + message + "<br>" + time + "<br>", true);
      xhttp.send();
      }
      ...
      div.innerHTML = "<p1>" + "Nita: " + "</p1>" + message + "<p>" + time + "<p>";
      document.getElementById( "messageArea" ).appendChild(div);
